...
export const metadata: Metadata = {
  title: "ASLA - Firearm Encyclopedia",
  description: "A curated one-page firearm reference with factual specifications, categories, and a PostgreSQL-backed collection.",
};
